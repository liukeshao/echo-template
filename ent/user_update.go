...
func (uu *UserUpdate) AddGrantedRoleIDs(ids ...string) *UserUpdate {
	uu.mutation.AddGrantedRoleIDs(ids...)
	return uu
}

// AddGrantedRoles adds the "granted_roles" edges to the UserRole entity.
func (uu *UserUpdate) AddGrantedRoles(u ...*UserRole) *UserUpdate {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uu.AddGrantedRoleIDs(ids...)
}
...
// ClearGrantedRoles clears all "granted_roles" edges to the UserRole entity.
func (uu *UserUpdate) ClearGrantedRoles() *UserUpdate {
	uu.mutation.ClearGrantedRoles()
	return uu
}

// RemoveGrantedRoleIDs removes the "granted_roles" edge to UserRole entities by IDs.
func (uu *UserUpdate) RemoveGrantedRoleIDs(ids ...string) *UserUpdate {
	uu.mutation.RemoveGrantedRoleIDs(ids...)
	return uu
}

// RemoveGrantedRoles removes "granted_roles" edges to UserRole entities.
func (uu *UserUpdate) RemoveGrantedRoles(u ...*UserRole) *UserUpdate {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uu.RemoveGrantedRoleIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.GrantedRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.GrantedRolesTable,
			Columns: []string{user.GrantedRolesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(userrole.FieldID, field.TypeString),
			},
	...
	if nodes := uu.mutation.RemovedGrantedRolesIDs(); len(nodes) > 0 && !uu.mutation.GrantedRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.GrantedRolesTable,
	...
	if nodes := uu.mutation.GrantedRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.GrantedRolesTable,
...
// AddGrantedRoleIDs adds the "granted_roles" edge to the UserRole entity by IDs.
func (uuo *UserUpdateOne) AddGrantedRoleIDs(ids ...string) *UserUpdateOne {
	uuo.mutation.AddGrantedRoleIDs(ids...)
	return uuo
}

// AddGrantedRoles adds the "granted_roles" edges to the UserRole entity.
func (uuo *UserUpdateOne) AddGrantedRoles(u ...*UserRole) *UserUpdateOne {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uuo.AddGrantedRoleIDs(ids...)
}
...
// ClearGrantedRoles clears all "granted_roles" edges to the UserRole entity.
func (uuo *UserUpdateOne) ClearGrantedRoles() *UserUpdateOne {
	uuo.mutation.ClearGrantedRoles()
	return uuo
}

// RemoveGrantedRoleIDs removes the "granted_roles" edge to UserRole entities by IDs.
func (uuo *UserUpdateOne) RemoveGrantedRoleIDs(ids ...string) *UserUpdateOne {
	uuo.mutation.RemoveGrantedRoleIDs(ids...)
	return uuo
}

// RemoveGrantedRoles removes "granted_roles" edges to UserRole entities.
func (uuo *UserUpdateOne) RemoveGrantedRoles(u ...*UserRole) *UserUpdateOne {
	ids := make([]string, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uuo.RemoveGrantedRoleIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.GrantedRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.GrantedRolesTable,
	...
	if nodes := uuo.mutation.RemovedGrantedRolesIDs(); len(nodes) > 0 && !uuo.mutation.GrantedRolesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.GrantedRolesTable,
	...
	if nodes := uuo.mutation.GrantedRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.GrantedRolesTable,
