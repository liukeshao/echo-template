...
// DeptIdsIsNil applies the IsNil predicate on the "dept_ids" field.
func DeptIdsIsNil() predicate.Role {
	return predicate.Role(sql.FieldIsNull(FieldDeptIds))
}

// DeptIdsNotNil applies the NotNil predicate on the "dept_ids" field.
func DeptIdsNotNil() predicate.Role {
	return predicate.Role(sql.FieldNotNull(FieldDeptIds))
}
