...
func (mu *MenuUpdate) SetAlwaysShow(b bool) *MenuUpdate {
	mu.mutation.SetAlwaysShow(b)
	return mu
}

// SetNillableAlwaysShow sets the "always_show" field if the given value is not nil.
func (mu *MenuUpdate) SetNillableAlwaysShow(b *bool) *MenuUpdate {
	if b != nil {
		mu.SetAlwaysShow(*b)
	}
	return mu
...
func (mu *MenuUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.AlwaysShow(); ok {
...
// SetAlwaysShow sets the "always_show" field.
func (muo *MenuUpdateOne) SetAlwaysShow(b bool) *MenuUpdateOne {
	muo.mutation.SetAlwaysShow(b)
	return muo
}

// SetNillableAlwaysShow sets the "always_show" field if the given value is not nil.
func (muo *MenuUpdateOne) SetNillableAlwaysShow(b *bool) *MenuUpdateOne {
	if b != nil {
		muo.SetAlwaysShow(*b)
	}
	return muo
...
func (muo *MenuUpdateOne) sqlSave(ctx context.Context) (_node *Menu, err error) {
	...
	if value, ok := muo.mutation.AlwaysShow(); ok {
		_spec.SetField(menu.FieldAlwaysShow, field.TypeBool, value)
	}
