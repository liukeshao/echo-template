...
func (*Position) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case position.FieldDeletedAt, position.FieldSortOrder:
			values[i] = new(sql.NullInt64)
		case position.FieldID, position.FieldName, position.FieldCode, position.FieldDescription, position.FieldStatus:
