...
func (pc *PermissionCreate) SetStatus(pe permission.Status) *PermissionCreate {
	pc.mutation.SetStatus(pe)
	return pc
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableStatus(pe *permission.Status) *PermissionCreate {
	if pe != nil {
		pc.SetStatus(*pe)
	}
	return pc
...
func (pc *PermissionCreate) SetSortOrder(i int) *PermissionCreate {
	pc.mutation.SetSortOrder(i)
	return pc
}

// SetNillableSortOrder sets the "sort_order" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableSortOrder(i *int) *PermissionCreate {
	if i != nil {
		pc.SetSortOrder(*i)
	}
	return pc
